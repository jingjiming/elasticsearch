...
public class WeChatException extends Exception {
    ...
    private static final String DEFAULT_ERROR = "WeChat Error";
    ...
    private static final Map<Integer, String> errmsgMap = new HashMap<Integer, String>() {

        {
            ...
            put(60001, "未能成功绑定微信账号");
            put(60002, "关键字重复");

            put(70001, "微信服务器异常，无法连接");
        }
    ...
    public WeChatException(int errCode) {
        ...
        if (errmsgMap.get(errCode) != null) {
            this.errMsg = errmsgMap.get(errCode);
        } else {
            this.errMsg = DEFAULT_ERROR;
        }
    }
